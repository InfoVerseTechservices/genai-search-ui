# How to Contribute to ColomboAI

Thanks for your interest in contributing to ColomboAI! Your help makes this project better. This guide explains how to contribute effectively.

ColomboAI is a modern AI chat application with advanced search capabilities.

## Project Structure

ColomboAI's codebase is organized as follows:
...
- **UI Components and Pages**:
  ...
  - **API Routes (`src/app/api`)**: API endpoints implemented with Next.js API routes.
    ...
    - `/api/search`: Provides direct access to ColomboAI's search capabilities.
...
ColomboAI exposes several API endpoints for programmatic access, including:

- **Search API**: Access ColomboAI's advanced search capabilities directly via the `/api/search` endpoint. For detailed documentation, see `docs/api/search.md`.
...
Following these steps will help maintain the integrity of ColomboAI's codebase and facilitate a smoother integration of your valuable contributions. Thank you for your support and commitment to improving ColomboAI.
