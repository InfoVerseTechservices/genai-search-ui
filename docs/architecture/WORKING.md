# How does ColomboAI work?

Curious about how ColomboAI works? Don't worry, we'll cover it here. Before we begin, make sure you've read about the architecture of ColomboAI to ensure you understand what it's made up of. Haven't read it? You can read it [here](https://github.com/InfoVerse/ColomboAI/tree/master/docs/architecture/README.md).

We'll understand how ColomboAI works by taking an example of a scenario where a user asks: "How does an A.C. work?". We'll break down the process into steps to make it easier to understand. The steps are as follows:
